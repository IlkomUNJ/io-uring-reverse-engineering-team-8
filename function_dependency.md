...
| | io_uring/io_uring.h | io_get_time | 3 |
...
| | include/linux/uio.h | iov_iter_ubuf | 3 |
...
| | io_uring/kbuf.c | io_buffers_select | 3 |
...
| | io_uring/io_uring.h | io_alloc_req | 3 |
...
| | include/linux/fcntl.h | force_o_largefile | 3 |
...
| | include/linux/bits.h | GENMASK | 3 |
| | io_uring/poll.c | io_init_poll_iocb | 6 |
| | io_uring/napi.h | io_napi_add | 6 |
| | include/linux/spinlock.h | spin_unlock_irq | 6 |
| | io_uring/io_uring.h | io_ring_submit_lock | 9 |
| | io_uring/io_uring.h | io_req_task_work_add | 3 |
| | io_uring/poll.c | io_poll_add_hash | 6 |
| | include/linux/rcupdate.h | rcu_read_lock | 6 |
| | include/linux/spinlock.h | spin_lock_irq | 6 |
| | include/linux/swab.h | swahw32 | 3 |
| | io_uring/poll.c | io_req_alloc_apoll | 3 |
| | include/linux/slab.h | kmalloc | 6 |
| | include/linux/atomic/atomic-instrumented.h | atomic_cmpxchg | 3 |
| | io_uring/poll.c | io_poll_cancel_req | 6 |
| | drivers/gpu/drm/radeon/mkregtable.c | container_of | 9 |
| | include/linux/lockdep.h | lockdep_assert_held | 6 |
| | io_uring/io_uring.c | io_poll_issue | 3 |
| | io_uring/io_uring.c | io_req_task_complete | 6 |
| | io_uring/poll.c | io_poll_execute | 6 |
| | io_uring/cancel.c | io_cancel_req_match | 3 |
| | io_uring/poll.c | __io_arm_poll_handler | 6 |
| | include/asm-generic/barrier.h | smp_store_release | 3 |
| | drivers/comedi/drivers/ni_routing/tools/convert_c_to_py.c | BIT | 6 |
| | io_uring/poll.c | io_poll_add | 3 |
| | io_uring/io_uring.c | io_req_task_submit | 6 |
| | include/linux/io_uring_types.h | io_kiocb_to_cmd | 24 |
| | include/linux/list.h | list_del_init | 9 |
| | include/linux/list.h | INIT_HLIST_NODE | 3 |
| | include/linux/atomic/atomic-instrumented.h | atomic_or | 3 |
| | drivers/gpu/drm/radeon/mkregtable.c | INIT_LIST_HEAD | 3 |
| | io_uring/io_uring.h | io_req_set_res | 18 |
| | io_uring/poll.c | io_poll_req_insert | 3 |
| | io_uring/io_uring.c | __io_req_task_work_add | 3 |
| | include/linux/slab.h | kfree | 6 |
| | kernel/sched/wait.c | add_wait_queue | 3 |
| | io_uring/alloc_cache.h | io_cache_alloc | 3 |
| | io_uring/io_uring.c | io_match_task_safe | 3 |
| | io_uring/poll.c | io_poll_get_ownership | 12 |
| | include/linux/rcupdate.h | rcu_read_unlock | 6 |
| | io_uring/poll.c | io_poll_find | 6 |
| | io_uring/poll.c | io_poll_remove_entries | 12 |
| | io_uring/poll.c | io_poll_disarm | 3 |
| | io_uring/cancel.h | io_cancel_match_sequence | 3 |
refs.h | include/linux/atomic/atomic-instrumented.h | atomic_set | 3 |
| | include/linux/atomic/atomic-instrumented.h | atomic_dec | 3 |
| | io_uring/refs.h | __io_req_set_refcount | 3 |
| | include/linux/atomic/atomic-instrumented.h | atomic_dec_and_test | 4 |
| | include/linux/atomic/atomic-instrumented.h | atomic_inc | 3 |
| | include/linux/atomic/atomic-instrumented.h | atomic_read | 3 |
| | block/blk.h | req_ref_zero_or_close_to_overflow | 10 |
| | include/linux/compiler.h | likely | 3 |
| | include/linux/atomic/atomic-instrumented.h | atomic_inc_not_zero | 3 |
| | include/linux/compiler.h | data_race | 1 |
| | include/asm-generic/bug.h | WARN_ON_ONCE | 20 |
register.c | include/linux/cpumask.h | free_cpumask_var | 6 |
| | include/linux/xarray.h | xa_alloc_cyclic | 3 |
| | include/linux/wait.h | wake_up | 3 |
| | include/linux/uaccess.h | copy_to_user | 15 |
| | include/linux/bitops.h | __set_bit | 6 |
| | include/linux/wait.h | wq_has_sleeper | 6 |
| | io_uring/register.c | io_probe | 3 |
| | include/asm-generic/rwonce.h | WRITE_ONCE | 36 |
| | io_uring/register.c | io_register_restrictions | 3 |
| | arch/sparc/include/asm/compat.h | in_compat_syscall | 3 |
| | io_uring/register.c | io_register_personality | 3 |
| | kernel/compat.c | compat_get_bitmap | 3 |
| | include/linux/mutex.h | mutex_unlock | 27 |
| | arch/parisc/kernel/firmware.c | __releases | 3 |
| | io_uring/memmap.c | io_create_region_mmap_safe | 9 |
| | include/linux/uaccess.h | copy_from_user | 24 |
| | drivers/gpu/drm/imagination/pvr_stream.h | array_size | 9 |
| | include/linux/cpumask.h | cpumask_size | 6 |
| | lib/xarray.c | xa_erase | 3 |
| | include/linux/string.h | memdup_user | 3 |
| | io_uring/msg_ring.c | io_uring_sync_msg_ring | 3 |
| | io_uring/io_uring.c | io_activate_pollwq | 3 |
| | drivers/block/aoe/aoenet.c | __must_hold | 3 |
| | include/asm-generic/bug.h | WARN_ON_ONCE | 6 |
| | io_uring/register.c | io_uring_register_get_file | 3 |
| | io_uring/io-wq.c | io_wq_max_workers | 6 |
| | io_uring/rsrc.c | io_sqe_files_register | 3 |
| | io_uring/rsrc.c | io_sqe_buffers_register | 3 |
| | io_uring/tctx.c | io_ringfd_register | 3 |
| | io_uring/rsrc.c | io_register_rsrc_update | 6 |
| | io_uring/register.c | io_register_enable_rings | 3 |
| | include/linux/atomic/atomic-instrumented.h | atomic_read | 3 |
| | drivers/gpu/drm/amd/display/include/vector.h | struct_size | 3 |
| | io_uring/opdef.c | io_uring_op_supported | 3 |
| | io_uring/napi.c | io_unregister_napi | 3 |
| | arch/powerpc/boot/page.h | PAGE_ALIGN | 6 |
| | include/linux/xarray.h | XA_LIMIT | 3 |
| | io_uring/rsrc.c | io_register_rsrc | 6 |
| | arch/alpha/kernel/osf_sys.c | fget | 3 |
| | include/linux/compiler.h | unlikely | 9 |
| | io_uring/register.c | io_register_iowq_max_workers | 3 |
| | include/linux/percpu-refcount.h | percpu_ref_is_dying | 3 |
| | io_uring/register.c | io_parse_restrictions | 3 |
| | include/linux/io_uring.h | io_is_uring_fops | 3 |
| | io_uring/zcrx.c | io_register_zcrx_ifq | 1 |
| | io_uring/memmap.h | io_region_get_ptr | 9 |
| | arch/mips/boot/tools/relocs.h | ARRAY_SIZE | 9 |
| | io_uring/register.c | io_unregister_iowq_aff | 3 |
| | include/linux/sched/task.h | get_task_struct | 3 |
| |  | trace_io_uring_register | 3 |
| | include/linux/slab.h | kzalloc | 3 |
| | include/linux/mutex.h | mutex_lock | 24 |
| | include/linux/cpumask_types.h | cpumask_bits | 3 |
| | io_uring/register.c | __io_uring_register | 3 |
| | io_uring/filetable.c | io_register_file_alloc_range | 3 |
| | include/linux/cpumask.h | alloc_cpumask_var | 3 |
| | io_uring/rsrc.c | io_sqe_files_unregister | 3 |
| | include/asm-generic/rwonce.h | READ_ONCE | 21 |
| | io_uring/register.c | __io_register_iowq_aff | 6 |
| | io_uring/eventfd.c | io_eventfd_unregister | 3 |
| | io_uring/kbuf.c | io_register_pbuf_ring | 3 |
| | include/linux/spinlock.h | spin_unlock | 3 |
| | io_uring/register.c | io_register_resize_rings | 3 |
| | io_uring/register.c | io_register_iowq_aff | 3 |
| | io_uring/sqpoll.c | io_sq_thread_unpark | 3 |
| | drivers/gpu/drm/radeon/mkregtable.c | list_for_each_entry | 3 |
| | io_uring/kbuf.c | io_register_pbuf_status | 3 |
| | io_uring/memmap.c | io_free_region | 9 |
| | io_uring/register.c | io_register_mem_region | 3 |
| | io_uring/memmap.h | io_region_is_set | 3 |
| | io_uring/rsrc.c | io_register_clone_buffers | 3 |
| | io_uring/io-wq.c | io_wq_cpu_affinity | 3 |
| | include/linux/err.h | PTR_ERR | 6 |
| | include/linux/refcount.h | refcount_inc | 3 |
| | io_uring/register.c | io_register_free_rings | 15 |
| | io_uring/register.c | io_uring_register_blind | 3 |
| | arch/parisc/kernel/firmware.c | __acquires | 3 |
| | include/linux/cred.h | get_current_cred | 3 |
| | crypto/asymmetric_keys/x509_parser.h | IS_ERR | 6 |
| | arch/x86/include/asm/kvm-x86-ops.h | BUILD_BUG_ON | 3 |
| | io_uring/io_uring.c | io_uring_fill_params | 3 |
| | include/linux/cpumask.h | cpumask_clear | 3 |
| | include/linux/cred.h | put_cred | 6 |
| | include/linux/kernel.h | u64_to_user_ptr | 3 |
| | io_uring/cancel.c | io_sync_cancel | 3 |
| | io_uring/rsrc.c | io_register_files_update | 3 |
| | io_uring/napi.c | io_register_napi | 3 |
| | io_uring/sqpoll.c | io_sqpoll_wq_cpu_affinity | 3 |
| | include/linux/fs.h | get_file | 3 |
| | include/linux/err.h | ERR_PTR | 9 |
| | include/linux/slab.h | kfree | 6 |
| | io_uring/sqpoll.c | io_put_sq_data | 6 |
| | io_uring/tctx.c | io_ringfd_unregister | 3 |
| | io_uring/io_uring.c | rings_size | 3 |
| | include/linux/atomic/atomic-instrumented.h | atomic_set | 3 |
| | arch/alpha/include/asm/string.h | memset | 12 |
| | io_uring/rsrc.c | io_sqe_buffers_unregister | 3 |
| | io_uring/eventfd.c | io_eventfd_register | 6 |
| | io_uring/register.c | io_unregister_personality | 3 |
| | include/linux/nospec.h | array_index_nospec | 6 |
| | arch/x86/boot/bitops.h | test_bit | 3 |
| | io_uring/register.c | io_register_clock | 3 |
| | io_uring/kbuf.c | io_unregister_pbuf_ring | 3 |
| | fs/file_table.c | fput | 6 |
| | include/linux/fortify-string.h | memchr_inv | 9 |
| | io_uring/sqpoll.c | io_sq_thread_park | 3 |
| | io_uring/register.c | swap_old | 6 |
| | drivers/gpu/drm/msm/disp/dpu1/dpu_crtc.h | spin_lock | 3 |
rsrc.h | io_uring/rsrc.h | io_put_rsrc_node | 9 |
| | include/linux/nospec.h | array_index_nospec | 3 |
| | arch/arm/include/asm/uaccess-asm.h | IS_ENABLED | 1 |
| | io_uring/rsrc.c | io_free_rsrc_node | 3 |
| | io_uring/rsrc.h | io_req_assign_rsrc_node | 3 |
| | include/linux/lockdep.h | lockdep_assert_held | 3 |
| | io_uring/rsrc.c | io_vec_free | 2 |
| | include/linux/atomic/atomic-instrumented.h | atomic_long_sub | 3 |
rsrc.c | include/linux/err.h | PTR_ERR | 19 |
| | io_uring/rsrc.c | __io_sqe_buffers_update | 3 |
| | include/linux/compiler.h | unlikely | 22 |
| | include/linux/blk-mq.h | blk_rq_bytes | 1 |
| | io_uring/rsrc.c | io_vec_fill_bvec | 1 |
| | include/linux/refcount.h | refcount_set | 4 |
| | io_uring/rsrc.c | headpage_already_acct | 3 |
| | io_uring/io_uring.h | io_ring_submit_unlock | 6 |
| | include/linux/bvec.h | for_each_mp_bvec | 1 |
| | lib/iov_iter.c | iovec_from_user | 7 |
| | arch/x86/include/asm/kvm-x86-ops.h | BUILD_BUG_ON | 3 |
| | include/linux/overflow.h | struct_size_t | 2 |
| | lib/iov_iter.c | iov_iter_bvec | 5 |
| | io_uring/filetable.c | io_alloc_file_tables | 3 |
| | io_uring/rsrc.c | io_files_update_with_index_alloc | 3 |
| | include/linux/mutex.h | mutex_unlock | 6 |
| | io_uring/rsrc.c | __io_sqe_files_update | 3 |
| | io_uring/io_uring.h | req_set_fail | 3 |
| | io_uring/alloc_cache.c | io_alloc_cache_init | 2 |
| | io_uring/rsrc.c | __io_register_rsrc_update | 9 |
| | io_uring/rsrc.c | io_free_imu | 2 |
| | io_uring/rsrc.c | io_check_coalesce_buffer | 3 |
| | io_uring/rsrc.c | io_sqe_files_register | 3 |
| | io_uring/filetable.h | io_slot_file | 5 |
| | io_uring/rsrc.c | lock_two_rings | 3 |
| | io_uring/filetable.h | io_file_table_set_alloc_range | 6 |
| | drivers/vdpa/mlx5/core/mr.c | kvfree | 14 |
| | include/linux/io_uring_types.h | io_kiocb_to_cmd | 9 |
| | io_uring/io_uring.h | io_ring_submit_lock | 6 |
| | io_uring/rsrc.c | io_unaccount_mem | 3 |
| | include/linux/atomic/atomic-instrumented.h | atomic_long_read | 3 |
| | include/linux/blk-mq.h | rq_data_dir | 1 |
| | include/linux/overflow.h | check_add_overflow | 17 |
| | include/linux/refcount.h | refcount_dec_and_test | 3 |
| | include/asm-generic/bug.h | WARN_ON_ONCE | 9 |
| | crypto/asymmetric_keys/x509_parser.h | IS_ERR | 19 |
| | io_uring/rsrc.c | io_buffer_validate | 6 |
| | io_uring/rsrc.c | __io_account_mem | 3 |
| | include/linux/blk-mq.h | blk_rq_nr_phys_segments | 1 |
| | io_uring/memmap.c | io_pin_pages | 3 |
| | include/linux/nospec.h | array_index_nospec | 5 |
| | include/linux/err.h | ERR_PTR | 6 |
| | io_uring/rsrc.h | io_req_assign_buf_node | 1 |
| | io_uring/filetable.h | io_file_bitmap_clear | 3 |
| | include/linux/atomic/atomic-instrumented.h | atomic64_add | 3 |
| | io_uring/rsrc.c | io_sqe_buffers_unregister | 3 |
| | io_uring/rsrc.c | io_sqe_buffer_register | 6 |
| | include/linux/lockdep.h | lockdep_assert_held | 9 |
| | io_uring/rsrc.c | io_kern_bvec_size | 1 |
| | arch/alpha/include/asm/string.h | memcpy | 1 |
| | fs/btrfs/extent_io.h | folio_shift | 3 |
| | include/linux/refcount.h | refcount_inc | 3 |
| | io_uring/alloc_cache.c | io_alloc_cache_free | 2 |
| | io_uring/rsrc.c | iov_kern_bvec_size | 1 |
| | include/linux/mm_types.h | compound_head | 12 |
| | io_uring/rsrc.c | io_sqe_files_unregister | 3 |
| | io_uring/io_uring.c | io_post_aux_cqe | 3 |
| | io_uring/rsrc.c | io_vec_fill_kern_bvec | 1 |
| | io_uring/alloc_cache.h | io_cache_alloc | 2 |
| | io_uring/rsrc.c | io_sqe_buffers_register | 3 |
| | arch/powerpc/boot/types.h | min_t | 7 |
| | io_uring/rsrc.h | __io_unaccount_mem | 3 |
| | arch/alpha/kernel/osf_sys.c | fget | 9 |
| | io_uring/rsrc.c | io_coalesce_buffer | 3 |
| | include/linux/slab.h | kfree | 4 |
| | include/linux/fortify-string.h | memchr_inv | 3 |
| | include/linux/io_uring_types.h | cmd_to_io_kiocb | 2 |
| | arch/parisc/include/asm/processor.h | rlimit | 6 |
| | io_uring/openclose.c | __io_close_fixed | 3 |
| | io_uring/rsrc.h | io_rsrc_node_lookup | 4 |
| | include/linux/mutex.h | mutex_lock | 3 |
| | io_uring/alloc_cache.h | io_cache_free | 3 |
| | linux/linux/mm/gup.c | unpin_user_page | 3 |
| | io_uring/io_uring.h | io_is_compat | 1 |
| | io_uring/filetable.h | io_fixed_file_set | 6 |
| | io_uring/rsrc.c | io_vec_free | 2 |
| | linux/linux/mm/gup.c | unpin_user_pages | 9 |
| | include/linux/kernel.h | u64_to_user_ptr | 27 |
| | io_uring/io_uring.h | io_req_set_res | 3 |
| | io_uring/rsrc.c | io_vec_realloc | 2 |
| | include/linux/page-flags.h | PageCompound | 9 |
| | lib/iov_iter.c | iov_iter_advance | 1 |
| | arch/arm64/kernel/pi/relacheck.c | swap | 3 |
| | include/linux/io_uring.h | io_is_uring_fops | 6 |
| | io_uring/register.c | io_uring_register_get_file | 3 |
| | include/linux/slab.h | kvmalloc_array | 6 |
| | include/linux/blk-mq.h | rq_for_each_bvec | 1 |
| | io_uring/filetable.c | io_fixed_fd_install | 3 |
| | include/asm-generic/rwonce.h | READ_ONCE | 9 |
| | include/linux/mm.h | folio_nr_pages | 3 |
| | io_uring/rsrc.c | io_account_mem | 3 |
| | include/linux/atomic/atomic-instrumented.h | atomic64_sub | 3 |
| | include/linux/uaccess.h | copy_to_user | 3 |
| | fs/btrfs/extent_io.h | folio_size | 3 |
| | arch/arm64/kvm/ptdump.c | release | 1 |
| | io_uring/filetable.c | io_free_file_tables | 3 |
| | io_uring/rsrc.c | io_rsrc_node_alloc | 13 |
| | io_uring/rsrc.c | io_alloc_imu | 2 |
| | include/linux/atomic/atomic-instrumented.h | atomic_long_try_cmpxchg | 3 |
| | include/linux/slab.h | kvmalloc | 3 |
| | arch/arc/include/asm/arcregs.h | min | 3 |
| | io_uring/rsrc.c | io_buffer_unmap | 3 |
| | io_uring/rsrc.h | io_reset_rsrc_node | 6 |
| | include/linux/slab.h | kmalloc_array | 1 |
| | io_uring/rsrc.h | io_put_rsrc_node | 6 |
| | io_uring/rsrc.c | io_clone_buffers | 3 |
| | include/linux/bvec.h | bvec_iter_advance | 1 |
| | arch/alpha/include/asm/string.h | memset | 9 |
| | io_uring/rsrc.c | io_estimate_bvec_size | 1 |
| | include/linux/mutex.h | mutex_lock_nested | 3 |
| | include/linux/uaccess.h | copy_from_user | 33 |
| | io_uring/filetable.h | io_file_bitmap_set | 6 |
| | Documentation/scheduler/sched-pelt.c | max | 3 |
| | io_uring/rsrc.c | io_buffer_account_pin | 3 |
| | arch/arm/kernel/atags_compat.c | page_size | 3 |
| | fs/file_table.c | fput | 18 |
| | io_uring/rsrc.c | io_rsrc_data_alloc | 6 |
| | io_uring/rsrc.c | io_find_buf_node | 2 |
| | include/linux/page-flags.h | page_folio | 9 |
| | io_uring/rsrc.c | io_rsrc_data_free | 9 |
| | io_uring/rsrc.c | io_import_fixed | 1 |
| | include/linux/mm.h | folio_page_idx | 6 |
| | io_uring/rsrc.c | validate_fixed_range | 3 |
| | include/linux/bvec.h | bvec_set_page | 4 |
rw.c | include/linux/hrtimer.h | hrtimer_set_expires | 3 |
| | include/linux/uio.h | iter_iov_len | 3 |
| | include/linux/compiler.h | likely | 6 |
| | io_uring/rw.c | io_rw_done | 3 |
| | io_uring/rw.c | io_kiocb_update_pos | 6 |
| | io_uring/rsrc.c | io_import_reg_buf | 1 |
| | io_uring/rw.c | io_iov_compat_buffer_select_prep | 3 |
| | kernel/sched/core.c | io_schedule | 3 |
| | include/linux/fs.h | kiocb_set_rw_flags | 3 |
| | io_uring/io-wq.h | io_wq_current_is_worker | 3 |
| | include/linux/fs.h | file_inode | 9 |
| | fs/read_write.c | rw_verify_area | 6 |
| | include/linux/hrtimer.h | destroy_hrtimer_on_stack | 3 |
| | include/linux/fsnotify.h | fsnotify_access | 3 |
| | io_uring/rw.c | io_fixup_rw_res | 12 |
| | arch/s390/hypfs/inode.c | read_iter | 3 |
| | kernel/time/hrtimer.c | hrtimer_sleeper_start_expires | 3 |
| | io_uring/rw.c | io_meta_save_state | 3 |
| | fs/direct-io.c | dio_complete | 3 |
| | io_uring/rsrc.c | io_import_reg_vec | 1 |
| | io_uring/rw.c | io_iter_do_read | 6 |
| | arch/alpha/kernel/perf_event.c | read | 3 |
| | io_uring/io_uring.h | io_is_compat | 2 |
| | io_uring/rw.c | io_prep_rw_pi | 3 |
| | io_uring/rw.c | kiocb_done | 6 |
| | include/asm-generic/bug.h | WARN_ON_ONCE | 3 |
| | include/asm-generic/barrier.h | smp_store_release | 3 |
| | lib/iov_iter.c | iov_iter_restore | 15 |
| | io_uring/rw.c | io_iov_buffer_select_prep | 3 |
| | io_uring/rw.c | io_rw_alloc_async | 3 |
| | io_uring/rw.c | io_hybrid_iopoll_delay | 3 |
| | io_uring/io_uring.h | io_file_can_poll | 12 |
| | drivers/media/i2c/adv748x/adv748x.h | io_read | 1 |
| | include/linux/uio.h | iov_iter_save_state | 16 |
| | include/linux/lockdep.h | lockdep_assert_held | 3 |
| | drivers/gpu/drm/radeon/mkregtable.c | INIT_LIST_HEAD | 3 |
| | io_uring/kbuf.c | io_buffer_select | 3 |
| | include/linux/uio.h | iter_is_ubuf | 3 |
| | include/linux/list.h | list_del_init | 3 |
| | io_uring/kbuf.h | io_do_buffer_select | 9 |
| | io_uring/rsrc.h | io_vec_reset_iovec | 1 |
| | include/linux/sched.h | __set_current_state | 3 |
| | io_uring/rw.c | io_file_supports_nowait | 6 |
| | lib/iov_iter.c | import_ubuf | 6 |
| | io_uring/io_uring.c | io_req_task_queue | 3 |
| | io_uring/rw.c | loop_rw_iter | 6 |
| | include/linux/io_uring_types.h | cmd_to_io_kiocb | 7 |
| | block/fops.c | iopoll | 3 |
| | io_uring/rsrc.c | io_prep_reg_iovec | 1 |
| | include/linux/fs.h | kiocb_start_write | 3 |
| | include/linux/uio.h | iov_iter_is_bvec | 6 |
| | kernel/time/hrtimer.c | hrtimer_cancel | 3 |
| | io_uring/rw.c | io_rw_init_file | 6 |
| | block/ioprio.c | ioprio_check_cap | 3 |
| | include/linux/ktime.h | ktime_set | 3 |
| | io_uring/rw.c | io_prep_rw | 13 |
| | io_uring/rw.c | io_rw_should_retry | 3 |
| | include/linux/percpu-refcount.h | percpu_ref_is_dying | 3 |
| | io_uring/rw.c | io_prep_rwv | 6 |
| | include/linux/fs.h | kiocb_end_write | 3 |
| | arch/s390/hypfs/inode.c | write_iter | 3 |
| | io_uring/rw.c | io_import_vec | 1 |
| | io_uring/rsrc.c | io_vec_free | 2 |
| | io_uring/io_uring.c | __io_req_task_work_add | 3 |
| | include/linux/fs.h | sb_start_write_trylock | 3 |
| | io_uring/rw.c | io_rw_do_import | 1 |
| | io_uring/kbuf.h | io_kbuf_recycle | 6 |
| | io_uring/io_uring.h | io_req_set_res | 15 |
| | arch/alpha/kernel/core_cia.c | write | 3 |
| | io_uring/rw.c | __io_read | 6 |
| | io_uring/rw.c | io_req_rw_cleanup | 12 |
| | io_uring/slist.h | wq_list_for_each | 3 |
| | include/linux/ioprio.h | get_current_ioprio | 3 |
| | io_uring/rw.c | __io_prep_rw | 6 |
| | io_uring/io_uring.c | __io_submit_flush_completions | 3 |
| | include/linux/uio.h | iter_iov_addr | 3 |
| | include/linux/blk-mq.h | rq_list_empty | 6 |
| | io_uring/rw.c | __io_complete_rw_common | 6 |
| | io_uring/rw.c | io_rw_should_reissue | 6 |
| | io_uring/alloc_cache.h | io_alloc_cache_put | 3 |
| | io_uring/rw.c | io_req_io_end | 6 |
| | include/linux/sched.h | set_current_state | 3 |
| | io_uring/io_uring.h | req_set_fail | 6 |
| | drivers/gpu/drm/radeon/mkregtable.c | container_of | 15 |
| | io_uring/rw.c | io_rw_recycle | 6 |
| | io_uring/rw.c | io_uring_classic_poll | 6 |
| | io_uring/rw.c | __io_import_rw_buffer | 1 |
| | include/uapi/linux/stat.h | S_ISREG | 3 |
| | io_uring/slist.h | wq_list_for_each_resume | 3 |
| | include/linux/blkdev.h | DEFINE_IO_COMP_BATCH | 3 |
| | io_uring/rw.c | io_req_end_write | 12 |
| | include/linux/slab.h | kfree | 7 |
| | io_uring/io_uring.h | req_has_async_data | 3 |
| | io_uring/rw.c | io_uring_hybrid_poll | 3 |
| | io_uring/rw.c | io_complete_rw_iopoll | 3 |
| | io_uring/rw.c | io_import_rw_buffer | 2 |
| | arch/arm/mach-rpc/ecard.c | complete | 3 |
| | io_uring/slist.h | wq_list_empty | 3 |
| | include/linux/fs.h | __sb_writers_release | 3 |
| | io_uring/rw.c | io_complete_rw | 3 |
| | include/uapi/linux/stat.h | S_ISBLK | 6 |
| | io_uring/poll.h | io_poll_multishot_retry | 3 |
| | include/linux/uio.h | iov_iter_count | 18 |
| | include/linux/pagemap.h | wake_page_match | 3 |
| | include/linux/io_uring_types.h | io_kiocb_to_cmd | 62 |
| | include/linux/uaccess.h | copy_from_user | 7 |
| | io_uring/rw.c | io_kiocb_ppos | 3 |
| | include/linux/timekeeping.h | ktime_get_ns | 6 |
| | include/asm-generic/barrier.h | smp_load_acquire | 3 |
| |  | trace_io_uring_short_write | 3 |
| | include/linux/fsnotify.h | fsnotify_modify | 3 |
| | io_uring/io_uring.c | io_req_task_complete | 3 |
| | include/asm-generic/rwonce.h | READ_ONCE | 30 |
| | include/linux/poll.h | vfs_poll | 3 |
| | include/linux/kernel.h | u64_to_user_ptr | 19 |
| | io_uring/rw.c | io_meta_restore | 9 |
| | io_uring/rsrc.h | io_alloc_cache_vec_kasan | 1 |
| | include/linux/compiler.h | unlikely | 72 |
| | io_uring/rw.c | io_rw_import_reg_vec | 2 |
| | lib/iov_iter.c | iov_iter_advance | 6 |
| | io_uring/rw.c | io_init_rw_fixed | 2 |
| | io_uring/slist.h | wq_list_cut | 3 |
| | io_uring/kbuf.h | io_put_kbuf | 15 |
| | io_uring/io_uring.c | io_file_get_flags | 3 |
| | drivers/media/i2c/adv748x/adv748x.h | io_write | 1 |
| | kernel/time/hrtimer.c | hrtimer_setup_sleeper_on_stack | 3 |
| | io_uring/io_uring.c | io_req_post_cqe | 3 |
| | lib/iov_iter.c | __import_iovec | 3 |
| | io_uring/io_uring.h | io_uring_alloc_async_data | 3 |
